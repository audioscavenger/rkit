...
for %%a in ("Enter=13" "Esc=27" "Endd=35" "Home=36" "LeftArrow=37" "RightArrow=39") do set %%a
...
:nextSelection
   ...
   for %%s in ("!option[%sel%]!") do set /P "=%BS%!CR!%~2!options: %%~s =[%ry%%k%%%~s%END%]!" < NUL
