...
set ffmpeglocation=C:\wintools\multimedia\MediaCoder64\codecs64
IF NOT EXIST %ffmpeglocation%\ set ffmpeglocation=E:\wintools\multimedia\MediaCoder64\codecs64
IF NOT EXIST %ffmpeglocation%\ echo ERROR: ffmpeg not found & timeout /t 10 & exit /b 1
...
if %ext%==m4a %~sdp0\yt-dlp %1 -x --ffmpeg-location C:\wintools\multimedia\MediaCoder64\codecs64 -S aext:m4a:mp3,acodec:aac:mp3 --no-keep-video --embed-metadata --add-metadata --cookies-from-browser %BROWSER%
...
REM if %ext%==m4a %~sdp0\yt-dlp %1 -x --ffmpeg-location C:\wintools\multimedia\MediaCoder64\codecs64 -S ext:mp4:m4a,aext:m4a:mp3,acodec:aac:mp3 --no-keep-video --embed-metadata --add-metadata --use-postprocessor FFmpegCopyStream --ppa CopyStream:"-c:v libx264 -c:a aac -f m4a"
REM if %ext%==m4a  %~sdp0\yt-dlp %1 --ffmpeg-location C:\wintools\multimedia\MediaCoder64\codecs64 --cookies-from-browser %BROWSER% --exec "C:\wintools\multimedia\MediaCoder64\codecs64\ffmpeg -i {} -c:v libx265 -c:a copy {}.h265.m4a"
...
if %ext%==mp3  %~sdp0\yt-dlp %1 -x --ffmpeg-location C:\wintools\multimedia\MediaCoder64\codecs64 --audio-format mp3 --no-keep-video --embed-metadata --add-metadata --cookies-from-browser %BROWSER%
goto :EOF
